...
const NotFound: FC = () => {
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-gray-100 text-gray-800">
      ...
      >
        <Link href="/">
          <span className="px-6 py-3 bg-blue-500 text-white text-sm font-medium rounded-full shadow hover:bg-blue-600 transition duration-300 ease-in-out">
            Go Back Home
          </span>
        </Link>
      </motion.div>
      ...
      <motion.div
        className="absolute inset-0 -z-10 bg-gradient-to-r from-blue-200 to-purple-300 opacity-20"
        initial={{ scale: 0.8 }}
        animate={{ scale: 1 }}
