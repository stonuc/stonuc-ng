          ...
          <motion.div variants={itemVariants} className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-gray-600">
                Chris has been working in IT industry since 2004. He worked for big and prestigious organizations
                handling large-scale digital transformation projects such as Dubai Municipality. He was part of UAE
                federal level projects such as digital signature (he has a registered patent for digital signature using
                Emirates ID) and digital ID. Moreover, he handled complex process automation projects and made
                exceptional improvements for customer's journeys accessing the government services. Husam has worked in
                the private sector as well. He managed large scale data governance projects.
              </p>
            </div>
          </motion.div>
        </motion.div>
